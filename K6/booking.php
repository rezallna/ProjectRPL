        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5"><span class="text-primary text-uppercase"></span>Isi Formulir</h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating" id="date3" data-target-input="nearest">
                                            <input type="date" class="form-control" id="checkin" name="checkin" placeholder="Check In" data-target="#date3" />
                                            <label for="checkin">Check In</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating" id="date4" data-target-input="nearest">
                                            <input type="date" class="form-control" id="checkout" name="checkout" placeholder="Check Out" data-target="#date4" />
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit" name="submit">Pesan Sekarang</button>
                                    </div>
                                </div>
                            </form>
                        </div>
